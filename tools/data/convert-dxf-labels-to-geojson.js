...
const rootArchiveDir = path.resolve(__dirname, '../../data/_archive/root');
const dxfPath = process.argv[2] || path.join(rootArchiveDir, 'BDDR Tong Final.dxf');
const outPath = process.argv[3] || path.join(rootArchiveDir, 'BDDR-labels.geojson');
